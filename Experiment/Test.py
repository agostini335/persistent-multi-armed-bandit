...
for run in range(n_runs):
    ...
    learners = [idea2_pos_f,idea2_pos_m,baseline_learner_m,bound1_learner_m,baseline_learner_f,bound1_learner_f,thomposon_baseline_m,thomposon_baseline_f,bayes_f,bayes_m]
