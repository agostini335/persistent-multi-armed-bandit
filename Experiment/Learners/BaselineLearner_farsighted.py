...
class BaselineLearner_farsighted (Learner):
    """
    class used to represent the Baseline Learner farsighted
    ....
    ...
    def __init__(self, n_arms, arms, tmax, tmin):
        super().__init__(n_arms,arms,"PR-T-UCB-P_farsighted")
    ...
    def update_observations(self, pulled_arm, bucket):
        ...
        for arm in range(self.n_arms):
            ...
            for b in self.arms[arm].buckets:
                ...
                if m  == self.tmax-1 or b.values[m] == 0:
